  ...
  return (
    <footer>
      <section>
        <article
          id="links"
          className="sm:flex-row flex-col sm:gap-x-36 gap-x-0 sm: gap-y-16 sm:gap-y-0 py-10"
        >
          <div id="nav_brand">
            ...
            <h4 className="poppins text-gray-200 font-light mt-2 leading-8 5xs:text-center">
              Pecahkan Masalah Pemrograman Bersama <br className="3xs:hidden" />
              Mentor yang Ahli dan Berpengalaman
            </h4>
            <a href="mailto:adityarizqiardhana@gmail.com" className="poppins">
              <BtnCustom classname="mt-6 5xs:mx-auto">Contact Us</BtnCustom>
            </a>
          </div>
          <div
            id="nav_links"
            className="grid grid-cols-2 sm:gap-x-20 5xs:grid-cols-1 5xs:justify-items-center 5xs:text-center 5xs:gap-y-8"
          >
        ...
        <article
          id="copyright"
          className="py-6 border-t border-gray-500 border-solid 5xs:text-center"
        >
