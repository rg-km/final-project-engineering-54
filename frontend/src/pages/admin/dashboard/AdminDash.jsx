            ...
            <div className="admindash-component">
                    ...
                    <div className="heading-admindash inter space-y-2">
                        {
                            ...
                            : "Admin tidak memiliki hak akses"
                        }
                ...
                <div className="container poppins">
                    <div className="py-8">
                        ...
                        <div className="my-3 flex sm:flex-row flex-col mt-5">
                            ...
                            <div className="block relative w-[30rem] max-w-full">
                                ...
                                <input placeholder="Cari murid atau mentor"
                                    ...
                                    <tbody>
                                        {
                                            ...
                                            users.filter( value => {
                                                ...
                                                else if (value.name.toLowerCase().includes(searchUser.toLowerCase().trim())) {
                                                    return value
                                                }
                                            })
                                            .map((e,i) => {
