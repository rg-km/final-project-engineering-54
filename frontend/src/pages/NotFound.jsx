        ...
        >
            <article className="notfound-component">
                <div id="container_notfound" className="flex flex-col justify-center items-center text-center space-y-16 py-10">
                    ...
                    <h1 className="text-gray-800 font-medium poppins text-[1.15rem]">Tetap tenang. Coba cek kembali alamat URL yang kamu masukkan atau kembali ke 
                        <Link to="/" className="text-blue-code font-semibold hover:text-orange-code leading-normal"> Halaman utama</Link>
                    </h1>
                </div>
